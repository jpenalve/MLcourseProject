...
<p float="left">
  <img src="ProjectCode/Results/Figures/64ch.png" width="300" />
  <img src="ProjectCode/Results/Figures/eegraw.png" width="400" /> 
</p>
...
Between 2D and 3D CNNs, we see that 3D performs better (cropped versions). This is consistent with the literature and intuitive. Since the electrodes are having a layout which physiologically makes sense in 3D version (the way they are attached to the head), the layout brings additional information, and this increases the accuracy.
